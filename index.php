...
<div class="row">
<div class="col-lg-6">
<span class="logo">CODE DAEMON</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="email" name="email" placeholder="someone@email.com" class="form-control text-muted" type="email">
...
<!-- sign in form begins -->  
<!--onSubmit="return validateForm()" can be used for validation too-->
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" maxlength="10" pattern="\d{10}" placeholder="Enter your mobile number" class="form-control input-md" type="text" required>
...
<a href="https://www.dbit.ac.in/about.php" target="_blank">About us</a>
</div>
<div class="col-md-4 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/MyPhoto.jpeg" width=100 height=100 alt="Niraj Pant" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href=# style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Niraj Pant</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8126372451</h4>
		<h4 style="font-family:'typo' ">nirajpant07@gmail.com</h4>
		<h4 style="font-family:'typo' ">Dev Bhoomi Institute of Technology, Dehradun</h4></div></div>
		</p>
      </div>
...
<div class="form-group">
<input type="text" name="uname" placeholder="someone@email.com" class="form-control"/> 
</div>
<div class="form-group">
